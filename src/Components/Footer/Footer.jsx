const Footer = ({ coins }) => {
    return (
        <div>
            <footer className=" rounded-tl-2xl rounded-2xl bg-black text-white p-10 mb-2">
                ...
                <div className=" mt-10 mb-10 grid grid-cols-2  gap-10 md:flex md:justify-between">
                    ...
                    <nav className="text-sm w-30 lg:w-90 text-justify">
                        <h6 className="footer-title text-lg">Our Goal</h6>
                        <p>
                    ...
                    <h6 className="footer-title text-lg">Subscribe</h6>
                        ...
                        <div className="join mt-2">
                            ...
                            <button className="btn text-black bg-green-300 hover:bg-green-500 border-2 border-b-emerald-400 join-item p-2 rounded-r-xl font-bold">Subscribe</button>
                        </div>
                    </fieldset>
                </div>
